...
<p>
	We have observed over the years that there is a lack of a central library of opinionated material
	with minimal code snippets for topics that form the core of a education beyond those presented by
	introductory courses to languages such as Solidity.
</p>
<p>
	...
	being intimidated by the size and complexity of large/popular protocols.
</p>
<p>
	We have observed that those that have the desire to improve their skillset often lack the time or
...
<ul>
	<li>
		...
		contributions from developers in their educational journey, technical writers and editors, and
	</li>
	<li>
		...
		direction to boost their confidence and skillset.
	</li>
</ul>
